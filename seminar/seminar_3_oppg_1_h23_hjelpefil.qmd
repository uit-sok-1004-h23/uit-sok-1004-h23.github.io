...
```{r}
# vi lager oss noen tall for L-variabelen
...
figur_2 <- figur_1 + 
  stat_function(df,
        fun=fun_1,
        mapping = aes(color = "fun_1")
        ) +
  
  scale_color_manual(values = c("fun_1" = "blue")) +
...
```{r}
# vi lager oss noen tall for X-variabelen
