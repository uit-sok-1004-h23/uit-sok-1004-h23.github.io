...
a) En Cobb-Douglas produktfunksjon viser hvordan produsert mengde kobles til produksjonsfaktorer. Med to faktorer (arbeidskraft, L, og kapital, K) kan denne sammenhengen vises i 3 dimensjoner. [Her](/rkode/F8_cobb_douglas_med_2_faktorer.R) finner du et eksempel som du kan kjøre i RStudio. For å vise produktfunksjonen i 2 dimensjoner kan man holde produsert mengde konstant, og se på hvilke kombinasjoner av L og K som gir nøyaktig dette produksjonsnivået. Kjør denne [koden](/seminar/produksjon med ggplot.R) i RStudio. Forklar det som vises på figuren. (Disse kurvene heter produksjonsisokvanter).      
