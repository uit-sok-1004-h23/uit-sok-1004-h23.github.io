...
# lagrer verdier i variabelen var_navn
var_navn <- df$var %>%
  unique()
```
...
Januar 2012 - september 2023.", x = "År", y = "Tolvmåneders endring, prosent", color = "") +
