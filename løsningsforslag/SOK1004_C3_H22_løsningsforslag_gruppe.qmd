...
*Løsningsforslag: Jeg henter inn totalindeks fra SSB og sammenligner. Seriene er like i 2020. De har en vedvarende nivåforskjell på andre datoer. Variasjonen er Jeg kan ikke se at manglende data kan forklare problemet, og stusser litt på resultatet. Kanskje de*
...
```{r}
df_bidrag <- df_indeks %>%
  mutate(verdi = (100*(verdi - dplyr::lag(verdi,12))*df_vekter$verdi/dplyr::lag(df_total$verdi,12)))
